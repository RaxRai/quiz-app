import { sports } from "/json/sports.js";
...
const getNewQues = () => {
  if (availableQuestions.length === 0 || questionCount >= MAX) {
    ...
    let highScore = localStorage.getItem("sportsHighScore");
    if (score > highScore) {
      localStorage.setItem("sportsHighScore", score);
    }
